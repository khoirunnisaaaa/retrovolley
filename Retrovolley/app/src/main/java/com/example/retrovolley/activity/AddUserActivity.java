...
public class AddUserActivity extends AppCompatActivity {
    ...
    private void submitByRetrofit(User user) {
        ...
        Retrofit.Builder builder = new Retrofit.Builder().baseUrl("http://192.168.43.39/retrovolley/").addConverterFactory(GsonConverterFactory.create());
    ...
    private void submitByVolley(User user){
        Gson gson = new Gson();
        String URL = "http://192.168.43.39/retrovolley/User_Registration.php";
